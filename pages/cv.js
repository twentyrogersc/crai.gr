  ...
  <Container>
    ...
    <Skills>
      <li>
        ...
        {' '}
        ES6, React, Redux, Backbone, Canvas, Webpack, Gulp, Browserify
      </li>
      <li><SkillsTitle>HTML5</SkillsTitle> Templating (Django, Mustache, etc), Jade</li>
      <li><SkillsTitle>CSS3</SkillsTitle> Modules, PostCSS, BEM, Sass, Stylus</li>
      <li>
        <SkillsTitle>Testing/Deployment</SkillsTitle> Mocha, ESLint, NPM, CircleCI, Node.js, TDD
      </li>
      <li><SkillsTitle>UI/UX</SkillsTitle> Wireframing, Sketch, Photoshop, Research</li>
    </Skills>
    ...
    <Links>
      <Link href="https://uk.linkedin.com/in/craigarogers">linkedin.com/in/craigarogers</Link><br />
      <Link href="mailto:hello@crai.gr">hello@crai.gr</Link><br />
