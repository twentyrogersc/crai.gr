...
export default () => (
  <Container>
    ...
    <Intro>
      An experienced and award-winning front-end developer just wanting to make great things. With
      interests spanning the latest in both design and technology, successful projects are developed
      at both a technical and conceptual level.
    </Intro>
    ...
    >
      ...
      and flexible product. Introduced build tools, styleguides (components), testing and continuous
      deployment into the stack. Projects mainly surround the core Unmade products, consisting of
      data-driven graphical programming (canvas) and interface implementation (react, redux, apis,
      etc).
    </Card>
    <Card
    ...
    >
      ...
      multi-lingual functionality. Clients included Sony Computer Entertainment Europe, HSBC and the
    ...
    <Card company="Unmade" date="2016" title="UMd" titleHref="https://umd.studio">
      ...
      customisable products, powered by highly configurable JavaScript modules.
    </Card>
    <Card
